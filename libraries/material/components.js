...
prx.types.material_dropdown_menu = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
		...
		cR += (typeof(item.listitems[item.selected]) != "undefined") ? item.listitems[item.selected].text : ((typeof(item.listitems[0]) != "undefined") ? item.listitems[0].text : '');
		cR += '</span>';
                ...
                [
                    {
                        ...
                        ,values: function(item,name) {
							...
							for (var n = 0; n < item.listitems.length; n++) {
								_rA.push({value: n, displayValue: item.listitems[n].text});
							}
							return _rA;
						}
                        ,changeProperty: {
...
prx.components.material_chip_with_avatar = {
    ...
    ,textSize: 14*prx.componentsHelper.getScale(_library)
    ,textColor: 'rgba(0,0,0,0.87)'
    ,imgSrc: {"fileId":"a338528b56a2f91841e8b97b1dd11fd9.png","assetType":"gallery","bucketsource":"main","name":" avatar_female.png"}
    ,actions: []
};
